...
router.get('/:categoryId', async (req, res, next) => {
  try {
    const recipe = await axios.get(`https://app.rakuten.co.jp/services/api/Recipe/CategoryRanking/20170426?applicationId=${process.env.RAKUTEN_APP}&categoryId=${req.params.categoryId}`);
